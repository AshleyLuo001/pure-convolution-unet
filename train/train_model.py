...
import sys 
sys.path.append('/home/luozichen/Project/ACC-UNet/Experiments/nets')
...
def main_loop(batch_size=config.batch_size, model_type='', tensorboard=True):
    ...
    if model_type == 'ACC_UNet':
        ...
        pretrained_dict =torch.load('/home/luozichen/Project/ACC-UNet/BUSI_exp1/UCTransNet/session/models/best_model-UCTransNet.pth') 
        config_vit = config.get_CTranS_config()
