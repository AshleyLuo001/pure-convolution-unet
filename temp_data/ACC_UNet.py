...
class ACC_UNet(torch.nn.Module):
    ...
    def load_from(self):
        pretrained_path = '/home/luozichen/Project/ACC-UNet/BUSI_exp1/ACC_UNet/session/models/best_model-ACC_UNet.pth'
        if pretrained_path is not None:
            ...
            print("---start load pretrained modle of ACC_UNet encoder---")
