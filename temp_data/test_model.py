...
sys.path.append('./')
import torch.optim
from temp_data.Load_Dataset import ValGenerator, ImageToImage2D
...
if __name__ == '__main__':
    ...
    temp_data ='./temp_data/'
    #save_path  = 'C:/Users/Administrator.SY-202304151755/Desktop/项目/Seed2023/model'
    vis_path = temp_data+'visualize_test/'
    ...
    fp = open('./temp_data/test.result','a')
